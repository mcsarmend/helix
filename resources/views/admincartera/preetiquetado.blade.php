...
@section('title', 'Preetiquetado Creditos')
...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h1>Preetiquetado Creditos</h1>
            <h1 class="card-title">Proceso que preetiqueta creditos.</h1>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col">
                ...
                <div class="row">
                    <div class="col">
                        <input value="Preetiquetar" id = "preetiquetarclic"class="btn btn-success">
                    </div>
                </div>
            </div>
        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#preetiquetarclic').click(function() {
                // Bloquea la pantalla
                $.blockUI({
                    message: 'Cargando...',
                    css: {
                ...
                Swal.fire({
                    ...
                    text: 'SIMULACION DE PREETIQUETADO EXITOSA'
                });
