...
@section('title', 'Etiquetado Creditos')
...
<br>
    <div class="card">
        <div class="card-header">
            <h1>Etiquetado Creditos</h1>
            <h1 class="card-title">Proceso que etiqueta creditos.</h1>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <input value="Etiquetar" id = "etiquetarclic"class="btn btn-primary">
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            $('#etiquetarclic').click(function() {
                ...
                Swal.fire({
                    ...
                    text: 'SIMULACION DE ETIQUETADO EXITOSA'
                });
