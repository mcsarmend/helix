...
@section('title', 'Edición Fideicomisos')
...
<br>
    <div class="card">
        <div class="card-header">
            <h1>Edición Fideicomisos</h1>
            <h1 class="card-title">Proceso que edita nombres de fideicomisos.</h1>
        </div>
        <div class="card-body">
            <form id="editar">
                @csrf
                ...
                <div class="row">
                    <div class="col">
                        <label for="newname">Nueva nombre:</label>
                    </div>
                    <div class="col">
                        <input type="text" id="newnameactualizar" name="newname" class="form-control">
                        <br><br>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#editar').submit(function(e) {
                ...
                $.ajax({
                    url: 'accionedicion', // Ruta al controlador de Laravel
                    type: 'POST',
